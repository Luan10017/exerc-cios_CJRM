...
// console.log(convertToString(35))
/*
  02
...
// console.log(getStringLength('Luan Andrade'))
...
const string = "CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"
...
// console.log(isItemIncluded(5,myNumbers))
...
*/
const myNames = ['Luan','Samir','Andre']
const myEmail = ['luan@cjrm.com','Samir@cjrm.com','Andre@cjrm.com']

const concatenaArray = (array1, array2) => array1.concat(array2)

// console.log(concatenaArray(myNames,myEmail))
...
// console.log(removeLastItem(myNumbers))
...
const involkeCallBack = callback => callback()

const logName = () => console.log('Luan')

involkeCallBack(logName)
...
const showNumbersInfo = (number,index, numbers) =>{
...
const creatParagraphs = paragraph => {
  paragraphs += `<p>${paragraph}</p>`
}

review.forEach(creatParagraphs)
...
console.log(likesToPeople(['luan','Thomas','Mari','Carol']))