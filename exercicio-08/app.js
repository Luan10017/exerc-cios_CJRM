...
function multiplication (firstNumber = 1, secondNumber = 1) {
...
const showNumber = function (number = 0) {
  console.log(`Esta é a ${number}ª vez que essa string é exibida.`)
}
/* 
for(let i= 1; i <= 7; i++) {
  showNumber(i)
...
const millennialWordsInUpperCase = arrayToUpperCase(millennialWords)

// console.log(millennianlInUpperCase)
/*
  05
...
const isOddNumbers = getOddNumbers([83, 52, 31, 73, 98, 37, 61, 56, 12, 24, 35, 3, 34, 80, 42])
